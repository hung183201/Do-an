...
import { Hotel, HotelManageClient, HotelRequest, HotelViewModel, TrangThai } from 'app/api-client';
...
@Component({
    selector: 'app-hotelcreateorupdate',
    templateUrl: './createorupdate-hotel.component.html',
    styleUrls: ['./createorupdate-hotel.component.scss'],
    encapsulation: ViewEncapsulation.None,
})


export class HotelCreatOrUpdateComponent implements OnInit {
    ...
    create() {
        ...
        this.hotelManageClient.add(new HotelViewModel({
